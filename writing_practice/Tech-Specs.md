...
## Checker
The checking System will do the following:
- It will transcribe the image or sketchpad input using arabic-small-nougat (https://huggingface.co/MohamedRashad/arabic-small-nougat)
- It will use an LLM to produce a literal translation of the transcription
<!-- - It will use another LLM to produce a grade -->
- It will determine the correctness of the input (Boolean: True), the output will be "correct" and "incorrect"
